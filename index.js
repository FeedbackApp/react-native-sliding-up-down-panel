    ...
    this.state.panResponder = PanResponder.create({
      ...
      onPanResponderMove: (event, gestureState) => {
        if(this.props.allowDragging) {
          ...
          if((Platform.OS === 'android' ? sliderPosition + a < this.props.maxDragHeight - (this.props.headerLayoutHeight + 25): sliderPosition + a < this.props.maxDragHeight - (this.props.headerLayoutHeight -2)) && sliderPosition + a > -2){
            if(sliderPosition !== 0) {
      ...
      onPanResponderRelease        : (e, gesture) => {
        ...
        if(this.props.allowAnimation) {
          if(a === 0 || (this.props.panelPosition === 'bottom' ? gesture.vy < -1 : gesture.vy > 1)) {
            if(sliderPosition < this.props.maxDragHeight-this.props.headerLayoutHeight) {
              sliderPosition = this.props.maxDragHeight-this.props.headerLayoutHeight
              this.props.onAnimationStart();
              Animated.timing(
                this.state.heightAnim,
...
SlidingPanel.propTypes = {
  ...
  maxDragHeight: PropTypes.number,
...
SlidingPanel.defaultProps = {
  ...
  maxDragHeight: Dimensions.get('window').height,
  headerLayout: () => {},
  visible: true,
  onDragStart: (event, gestureState) => {},
  onDragStop: (event, gestureState) => {},
